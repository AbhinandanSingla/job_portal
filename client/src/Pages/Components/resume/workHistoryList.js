...
export const WorkHistoryList = () => {
    ...
    return (<section className={'workHistoryList'}>
        <div className="max_width">
            <div className="heading">Work History</div>
            <div className="educationContainer">
                {
                    userDataProvider.workHistory.map((value, index) => <div className="educationLi" key={index}>
                             <span className="paraTag">
                            {index + 1}
                        </span>
                            <div className="ed_degree">
                                {value.jobtitle}
                            </div>
                            <span className="ed_schoolName">
                           | {value.employer} |
                        </span> <span className="ed_city">
                              | {value.country} |  </span><span className="ed_country">
                              | {value.city} |  </span>
                            <span className="ed_period">
            ...
            <div className="addDegree" onClick={() => navigate('/resume/education')}>
                ADD ANother Degree
            </div>
            <div className="buttonContainer educationbuttons">
