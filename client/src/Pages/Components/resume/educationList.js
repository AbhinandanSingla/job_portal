...
export const EducationList = () => {
    ...
    return (<>
        <div className="max_width">
            <div className="heading">Education Summary</div>
            <div className="educationContainer">
                {
                    userDataProvider.education.map((value, index) => <div className="educationLi" key={index}>
                           ...
                           | {value.schoolName} |
                            ...
                            <span className="ed_period">
                                {value.graduationStartDate}- {value.graduationEndDate}
                        </span>
