...
export function FindWorkContainer() {
    ...
    return (
        <div className={compareStyle.findWorkContainer}>
            {(data) ? data.jobList.map((value1, index) => <div className={compareStyle.findWorkCard}>
                    ...
                    <div className={compareStyle.fwc_description}>
                        <div className={compareStyle.fwc_heading}>{value1.jobTitle}</div>
                        <div className={"fwc_role"}>Position</div>
                        <div className={compareStyle.fwc_salary}>
                            <span>${value1.SalaryRange}</span>/ a month
                        </div>
