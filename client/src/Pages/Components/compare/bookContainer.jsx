...
export function BookContainer() {
    return (<div className={compareStyle.bookmarkContainer} style="display: none">
            ...
            >
                <SwiperSlide className="findWorkCard ">
                    ...
                    <div className="fwc_description">
                        <div className="fwc_heading">
                            Govt Dept
                        </div>
                        <div className="fwc_role">
                            Position
                        </div>
                        <div className="fwc_salary">
                            <span>$10,000</span>/ a month
                        </div>
                        <div className="fwc_locView">
        ...
        fill="#6083FE"/>
                ...
                <SwiperSlide className="findWorkCard ">
                    ...
                    <div className="fwc_description">
                        ...
                        <div className="fwc_site">Upload by Sarkari Results.com</div>
    ...
    <path
        ...
        fill="#6083FE"/>
            ...
            <div className="swiper">
                <div className="matches swiper-wrapper">
                    <div className="findWorkCard swiper-slide">
                        <div className="fwc-profile">
                            <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <rect width="64" height="64" rx="10" fill="#E0E4F0"/>
