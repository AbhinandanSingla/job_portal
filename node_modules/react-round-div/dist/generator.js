export default function generateSvgSquircle(height, width, radius) {
  ...
  radius = _rawRadius.map((radius, i) => Math.min(radius, Math.min(height - _rawRadius[i % 2 === 0 ? prev(i) : next(i)], height / 2), Math.min(width - _rawRadius[i % 2 === 0 ? next(i) : prev(i)], width / 2)));
  const [a0x, a1x, a2x, a3y, a3x, b1y, b1x] = Array(7).fill(Array(4).fill(0)).map((a, i) => a.map((b, j) => radius[j] * ratios[i])),
        [b0y, b0x] = [a3y, a3x];
  ...
  const path = `M${startPoint} ${width / 2 < a0x[1] ? '' : `L${width - a0xw},0`} C${width - a1x[1]},0,${width - a2x[1]},0,${width - a3x[1]},${a3y[1]} C${width - b1x[1]},${b1y[1]},${width - b1y[1]},${b1x[1]},${width - b0y[1]},${b0x[1]} C${width},${a2x[1]},${width},${a1x[1]}, ${width - rightYOffset},${a0xh} ${height / 2 < a0x[2] ? '' : `L${width},${height - a0xh}`} C${width},${height - a1x[2]},${width},${height - a2x[2]},${width - a3y[2]},${height - a3x[2]} C${width - b1y[2]},${height - b1x[2]},${width - b1x[2]},${height - b1y[2]},${width - b0x[2]},${height - b0y[2]} C${width - a2x[2]},${height},${width - a1x[2]},${height}, ${width - a0xw},${height - bottomYOffset} ${width / 2 < a0x[3] ? '' : `L${a0xw},${height}`} C${a1x[3]},${height},${a2x[3]},${height},${a3x[3]},${height - a3y[3]} C${b1x[3]},${height - b1y[3]},${b1y[3]},${height - b1x[3]},${b0y[3]},${height - b0x[3]} C0,${height - a2x[3]},0,${height - a1x[3]}, ${leftYOffset},${height - a0xh} ${height / 2 < a0x[0] ? '' : `L0,${a0xh}`} C0,${a1x[0]},0,${a2x[0]},${a3y[0]},${a3x[0]} C${b1y[0]},${b1x[0]},${b1x[0]},${b1y[0]},${b0x[0]},${b0y[0]} C${a2x[0]},0,${a1x[0]},0,${startPoint} Z`.replace(/[\n ]/g, '').replace(/NaN/g, '0');
  if (path.match(/[^ M0LCZ,]/) === null) return '';
  return path;
}